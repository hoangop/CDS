...
# List User Agents thực tế (Chrome, Firefox, Safari trên Mac/Windows)
USER_AGENTS = [
...
def find_usnews_url_and_capture(school_name, output_path="temp_screenshot.png"):
    ...
    # Random User-Agent và Viewport để tránh bị phát hiện
    user_agent = random.choice(USER_AGENTS)
    viewport = random.choice(VIEWPORTS)
    
    print(f"   🎭 Using: {user_agent[:50]}... | Viewport: {viewport['width']}x{viewport['height']}")
    
    try:
        with sync_playwright() as p:
            # Launch browser với User-Agent ngẫu nhiên
            ...
            # Tạo context mới với viewport và user-agent random
            ...
            page = context.new_page()
             ...
             # 1. Vào Google (với delay ngẫu nhiên)
            ...
            if "google" in page.url:
                ...
                time.sleep(random.uniform(0.5, 1.5))  # Giả lập người gõ
            ...
            # Giả lập cuộn trang như người thật
...
def main():
    ...
    for inst_id, name in schools:
        ...
        # Delay ngẫu nhiên giữa các trường (3-8 giây)
